...
*
*/
.service('authenticationService', function($rootScope, $http, $q, $cookieStore) {
    var $auth = this;
...
.service('actionService', function($rootScope, $http, $location, authenticationService) {
...
*/
.service('feedbackService', function($window) {
    var popover = {
        content: '',
        elem: null
    };
