...
try {
    ...
    // retrieve given user
    $res = $om->read($object_class, $object_id, ['id', 'title', 'description', 'path', 'parent_id', 'parent_id.title', 'parent_id.path', 'count_questions', 'count_documents', 'count_articles', 'count_items']);
