...
define('RESIEXCHANGE_QUESTION_CONTENT_EXCERPT_LENGTH_MAX', 200);
...
define('RESILIB_DOCUMENT_FLAG_DAILY_MAX', 50);
define('RESILIB_COMMENT_FLAG_DAILY_MAX', 50);

define('RESILIB_DOCUMENT_CONTENT_EXCERPT_LENGTH_MAX', 200);


/*
* Articles
*/
define('RESILEXI_ARTICLE_DAILY_MAX', 200);

define('RESILEXI_ARTICLE_TITLE_LENGTH_MIN', 5);
define('RESILEXI_ARTICLE_TITLE_LENGTH_MAX', 256);

define('RESILEXI_ARTICLE_CONTENT_LENGTH_MIN', 128);
define('RESILEXI_ARTICLE_CONTENT_LENGTH_MAX', 64000);
define('RESILEXI_ARTICLE_CATEGORIES_COUNT_MIN', 1);
define('RESILEXI_ARTICLE_CATEGORIES_COUNT_MAX', 5);


define('RESILEXI_COMMENTS_DAILY_MAX', 100);

define('RESILEXI_ARTICLE_VOTEUP_DAILY_MAX', 50);
define('RESILEXI_ARTICLE_VOTEDOWN_DAILY_MAX', 50);
define('RESILEXI_COMMENT_VOTEUP_DAILY_MAX', 50);

define('RESILEXI_ARTICLE_FLAG_DAILY_MAX', 50);
define('RESILEXI_COMMENT_FLAG_DAILY_MAX', 50);

define('RESILEXI_ARTICLE_CONTENT_EXCERPT_LENGTH_MAX', 200);
