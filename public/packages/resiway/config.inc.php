...
*/
define('RESIEXCHANGE_QUESTION_TITLE_LENGTH_MIN', 20);
...
define('RESIEXCHANGE_ANSWER_CONTENT_LENGTH_MAX', 30000);
...
define('RESILIB_DOCUMENT_CATEGORIES_COUNT_MAX', 5);

define('RESILIB_DOCUMENT_TITLE_LENGTH_MIN', 5);
define('RESILIB_DOCUMENT_TITLE_LENGTH_MAX', 256);


define('RESILIB_COMMENTS_DAILY_MAX', 100);

define('RESILIB_DOCUMENT_VOTEUP_DAILY_MAX', 50);
define('RESILIB_DOCUMENT_VOTEDOWN_DAILY_MAX', 50);
define('RESILIB_COMMENT_VOTEUP_DAILY_MAX', 50);

define('RESILIB_COMMENT_FLAG_DAILY_MAX', 50);
