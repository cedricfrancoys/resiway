...
define('RESIEXCHANGE_QUESTION_CONTENT_LENGTH_MIN', 128);
define('RESIEXCHANGE_QUESTION_CONTENT_LENGTH_MAX', 4096);
define('RESIEXCHANGE_QUESTION_CATEGORIES_COUNT_MIN', 1);
define('RESIEXCHANGE_QUESTION_CATEGORIES_COUNT_MAX', 5);

define('RESIEXCHANGE_ANSWER_CONTENT_LENGTH_MIN', 128);
define('RESIEXCHANGE_ANSWER_CONTENT_LENGTH_MAX', 4096);
