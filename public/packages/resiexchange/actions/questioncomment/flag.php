...
$params = QNLib::announce(	
	array(	
    'description'	=>	"Registers a flag raised by a user on given comment of a question",
    'params' 		=>	array(                                         
                        'comment_id'	=> array(
                                            'description'   => 'Identifier of the (question-) comment the user is flaging.',
                                            'type'          => 'integer', 
                                            'required'      => true
                                            )                                       
                        )
...
list($action_name, $object_class, $object_id) = [
    'resiexchange_questioncomment_flag', 
    ...
    $result = ResiAPI::performAction(
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESIEXCHANGE_COMMENT_FLAG_DAILY_MAX) {
