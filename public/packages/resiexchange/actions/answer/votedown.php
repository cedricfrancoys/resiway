<?php
/* votedown.php - resiexchange_answer_votedown controller
...
/**
* This controller allows to toggle an answer between 'voted down' and 'not voted down' states (which differs from 'voted up')
* i.e.: one click marks the answer as voted down by current user, a second click unmarks it
*/
    ...
    $result = ResiAPI::performAction(
        ...
        function ($om, $user_id, $object_class, $object_id) {       // $do 
            ...
            if($concurrent_action) {
                ResiAPI::unregisterAction($user_id, 'resiexchange_answer_voteup', $object_class, $object_id);
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESIEXCHANGE_ANSWER_VOTEDOWN_DAILY_MAX) {
