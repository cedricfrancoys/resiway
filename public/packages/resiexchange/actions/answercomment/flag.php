...
$params = QNLib::announce(	
	array(	
    'description'	=>	"Registers a flag raised by a user on given comment of an answer",
    'params' 		=>	array(                                         
                        'comment_id'	=> array(
                                            'description'   => 'Identifier of the answer comment the user is flaging.',
                                            'type'          => 'integer', 
                                            'required'      => true
                                            )                                       
                        )
...
list($action_name, $object_class, $object_id) = [
    'resiexchange_answercomment_flag', 
