...
try {
    ...
    // retrieve document
    $result = [];
    $res = $om->read($object_class, $object_id, ['id', 'creator', 'created', 'editor', 'edited', 'modified', 'last_update', 'license', 'title', 'title_url', 'lang', 'description', 'author', 'pages', 'original_filename', 'count_stars', 'count_views', 'count_votes', 'score', 'categories_ids', 'comments_ids']);    
