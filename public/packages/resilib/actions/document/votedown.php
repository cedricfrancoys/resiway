<?php
/* votedown.php - resilib_document_votedown controller
...
/**
* This controller allows to toggle a document between 'voted down' and 'not voted down' states (which differs from 'voted up')
* i.e.: one click marks the document as voted down by current user, a second click unmarks it
*/
...
$params = QNLib::announce([
    'description'	=>	"Registers a vote up performed by a user on a document",
    'params' 		=>	[                                        
        'document_id'	=> [
            'description'   => 'Identifier of the document the user votes up.',
            'type'          => 'integer', 
            'required'      => true
        ]
    ]
    ...
    $result = ResiAPI::performAction(
        ...
        function ($om, $user_id, $object_class, $object_id) {       // $do 
            ...
            if($concurrent_action) {
                ResiAPI::unregisterAction($user_id, 'resilib_document_voteup', $object_class, $object_id);
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESILIB_DOCUMENT_VOTEDOWN_DAILY_MAX) {
