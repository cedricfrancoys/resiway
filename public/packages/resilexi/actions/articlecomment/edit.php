...
$params = QNLib::announce([
    'description'	=>	"Update a comment to a article",
    'params' 		=>	[
        'comment_id'	=> array(
                            'description'   => 'Identifier of the (article-) comment the user is updating.',
                            'type'          => 'integer', 
                            'required'      => true
                            ),
        'content'	    => array(
    ...
    $result = ResiAPI::performAction(
        ...
        [                                                          // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESILEXI_COMMENTS_DAILY_MAX) {
