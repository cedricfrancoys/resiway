...
$params = QNLib::announce(	
	array(	
    'description'	=>	"Registers a flag raised by a user on given comment of a article",
    'params' 		=>	array(                                         
                        'comment_id'	=> array(
                                            'description'   => 'Identifier of the (article-) comment the user is flaging.',
                                            'type'          => 'integer', 
                                            'required'      => true
                                            )                                       
                        )
    ...
    $result = ResiAPI::performAction(
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESILEXI_COMMENT_FLAG_DAILY_MAX) {
