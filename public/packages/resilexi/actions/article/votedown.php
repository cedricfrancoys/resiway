<?php
/* votedown.php - resilib_article_votedown controller
...
/**
* This controller allows to toggle a article between 'voted down' and 'not voted down' states (which differs from 'voted up')
* i.e.: one click marks the article as voted down by current user, a second click unmarks it
*/
...
$params = QNLib::announce([
    'description'	=>	"Registers a vote up performed by a user on a article",
    'params' 		=>	[                                        
        'article_id'	=> [
            'description'   => 'Identifier of the article the user votes up.',
            'type'          => 'integer', 
            'required'      => true
        ]
    ]
    ...
    $result = ResiAPI::performAction(
        ...
        function ($om, $user_id, $object_class, $object_id) {       // $do 
            ...
            if($concurrent_action) {
                ResiAPI::unregisterAction($user_id, 'resilexi_article_voteup', $object_class, $object_id);
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res[$object_id]['creator'] == $user_id) {
                    throw new Exception("article_created_by_user", QN_ERROR_NOT_ALLOWED);          
                }
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESILEXI_ARTICLE_VOTEDOWN_DAILY_MAX) {
