...
$params = QNLib::announce([
    'description'	=>	"Registers a article as favorite for current user",
    'params' 		=>	[
        'article_id'	=> [
            'description'   => 'Identifier of the article to star.',
            'type'          => 'integer', 
            'required'      => true
        ]
    ]
