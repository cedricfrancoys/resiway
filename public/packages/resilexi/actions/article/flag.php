...
$params = QNLib::announce(	
	array(	
    'description'	=>	"Registers a flag raised by a user on given article",
    'params' 		=>	array(                                         
                        'article_id'	=> array(
                                            'description'   => 'Identifier of the article the user is flaging.',
                                            'type'          => 'integer', 
                                            'required'      => true
                                            )                                       
                        )
    ...
    $result = ResiAPI::performAction(
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESILEXI_ARTICLE_FLAG_DAILY_MAX) {
