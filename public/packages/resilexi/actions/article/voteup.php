<?php
/* voteup.php - resilexi_article_voteup controller
...
/**
* This controller allows to toggle a article between 'voted up' and 'not voted up' states (which differs from 'voted down')
* i.e.: one click marks the article as voted up by current user, a second click unmarks it
*/
    ...
    $result = ResiAPI::performAction(
        ...
        function ($om, $user_id, $object_class, $object_id) {       // $do 
            ...
            if($concurrent_action) {
                ResiAPI::unregisterAction($user_id, 'resilexi_article_votedown', $object_class, $object_id);
        ...
        [                                                           // $limitations
            ...
            function ($om, $user_id, $action_id, $object_class, $object_id) {
                ...
                if($res > 0 && count($res) > RESILEXI_ARTICLE_VOTEUP_DAILY_MAX) {
