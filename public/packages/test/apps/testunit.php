...
$tests = array(
            ...
            '2100' => array(
                            ...
                            'test'              => function (){
                                                        return read('core\User', [ROOT_USER_ID], array('language','firstname','lastname'));
                                                   },
                            ),
            ...
            '2102' => array(
                            ...
                            'test'              => function (){
                                                        return read('core\User', (string) ROOT_USER_ID, array('language','firstname','lastname'));
                                                    },
                            ),
            ...
            '2103' => array(
                            ...
                            'expected'          => array(),
                            'test'              => function (){
                                                        return read('core\User', 0, array('language','firstname','lastname'));
                                                    },
                            ),
